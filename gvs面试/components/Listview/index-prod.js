...
class ListComponent extends Component {
  ...
  initData = props => {
    ...
    this.setState({
      ...
      height: document.documentElement.clientHeight - (props.height || 50),
  ...
  onEndReached = () => {
    let { pageIndex, pageSize, total } = this.props;
    ...
    return (
      <div className="pull-list">
        <ListView
          ...
          // 初始化渲染条数
          initialListSize={this.props.pageSize * this.props.pageIndex || 5}
          // 每次事件循环（每帧）渲染的行数
          pageSize={this.props.pageSize * this.props.pageIndex || 5}
        />
      </div>
    );
  }
